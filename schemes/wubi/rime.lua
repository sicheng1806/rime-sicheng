...
-- --==========================================================--==========================================================
-- 拆分数据匹配
new_spelling = require("wubi.new_spelling")
-- 监控并记录自造词至文件等，必须配置lua_processor@submit_text_processor
submit_text_processor = require("wubi.Submit_text")
helper = require("wubi.helper")
switch_processor = require("wubi.switcher")
calculator = require("wubi.calculator")
lunaDate = require("wubi.lunarDate")
lunarJq = require("wubi.lunarJq")
lunarGz = require("wubi.lunarGz")
number = require("wubi.number")
